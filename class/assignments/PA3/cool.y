...
%{
  ...
  for the location of tokens */
    ...
    */
    ...
    %type <formals> formal_list_help
    %type <formal> formal

    %type <expressions> arg_list
    %type <expressions> arg_helper
    ...
    */
    ...
    formal_list_help: formal
    { $$ = single_Formals($1); }
    | formal ',' formal_list_help
    ...
    arg_helper: expression
    { $$ = single_Expressions($1); }
    | arg_helper ',' expression
    { $$ = append_Expressions($1, single_Expressions($3)); }

    let_expression: OBJECTID ':' TYPEID ASSIGN expression IN expression
    { $$ = let($1, $3, $5, $7); }
